...
namespace Service.Core.DefinedTypes
{
    public enum Pkcs11Mechanism : uint
    {
        ...
        DSA                             = 0x00000011,
        DSA_SHA1                        = 0x00000012,
        DSA_FIPS_G_GEN                  = 0x00000013,
        DSA_SHA224                      = 0x00000014,
        DSA_SHA256                      = 0x00000015,
        DSA_SHA384                      = 0x00000016,
        DSA_SHA512                      = 0x00000017,
        ...
        TLS10_MAC_SERVER                = 0x000003D6,
        TLS10_MAC_CLIENT                = 0x000003D7,
