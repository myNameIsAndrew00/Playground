...
{  
   ...
   /// </summary>
    public interface IHashingModule : ITokenModule, IAllowMechanism 
    {
        /// <summary>
        /// Use this method to initialise the handler context with certain attributes and mechanism.
        /// </summary>
        /// <param name="mechanism">Mechanism specified for digest</param>
        ...
        /// <param name="executionResultCode">Result code. Ok code is returned if hashing was done with success</param>
        ...
        /// </summary>
        /// <param name="executionResultCode">Result code. Ok code is returned if digest finalise was done with success.</param>
        /// <returns>Result of the hashing process</returns>
